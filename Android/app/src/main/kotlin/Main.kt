...
internal val logger: SkipLogger = SkipLogger(subsystem = "edu.pal", category = "EduPal")

private typealias AppRootView = EduPalRootView
private typealias AppDelegate = EduPalAppDelegate
